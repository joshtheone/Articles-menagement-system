...
<html lang="en">
	<head>
		...
		<title>Noxiee-Business-Consulting HTML Template</title>
		<!-- Favicon -->
						...
						<div class="address-wrapper float-right">
							<ul>
								<li class="address">
									...
									<h6>Address:</h6>
									<p> Kariakoo St, Dar es salaam.</p>
								</li>
								<li class="address">
									<i class="icon flaticon-multimedia"></i>
									<h6>Mail us:</h6>
									<p>group03@mail.com</p>
								</li>
						...
						<div class="col-lg-3 col-md-4 col-6">
							<div class="single-product">
								...
								<div class="product-name">
									...
									<div class="price"><del>360,900sh </del> 3270sh</div>
									<div class="add-to-cart"><a href="shop-details.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ADD TO CART</a></div>
								</div>
							</div> <!-- /.single-product -->
						</div> <!-- /.col- -->
						...
						<div class="col-lg-3 col-md-4 col-6">
							<div class="single-product">
								...
								<div class="product-name">
									...
									<div class="price"><del>43,900sh </del>40000</div>
									<div class="add-to-cart"><a href="shop-details.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ADD TO CART</a></div>
								</div>
							</div> <!-- /.single-product -->
						</div> <!-- /.col- -->
						...
						<div class="col-lg-3 col-md-4 col-6">
							<div class="single-product">
								...
								<div class="product-name">
									...
									<div class="price"><del>9800sh</del>38700sh</div>
									<div class="add-to-cart"><a href="shop-details.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ADD TO CART</a></div>
								</div>
							</div> <!-- /.single-product -->
						</div> <!-- /.col- -->
					...
					<div class="container">
						<div class="row">
							<div class="col-xl-3 col-lg-4 col-sm-6 about-widget">
								...
								<div class="queries"><i class="flaticon-phone-call"></i> Any Queries : <a href="#">(+255) 625 515 533</a></div>
							</div> <!-- /.about-widget -->
								...
								<ul>
									<li class="clearfix">
										...
										<div class="post float-left">
											...
											<div class="date"><i class="fa fa-calendar-o" aria-hidden="true"></i> Nov 06, 2022</div>
										</div>
									</li>
									<li class="clearfix">
										...
										<div class="post float-left">
											...
											<div class="date"><i class="fa fa-calendar-o" aria-hidden="true"></i> Oct 20, 2022</div>
										</div>
									</li>
								</ul>
